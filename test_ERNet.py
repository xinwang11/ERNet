...
model = ERNet()
model.load_state_dict(torch.load('./models/ERNet_ORSSD.pth'))
...
for dataset in test_datasets:
    save_path = './models/ERNet/' + dataset + '/'
    ...
    for i in range(test_loader.size):
        ...
        imageio.imsave(save_path+name, res_int)
